...
export default function Footer() {
  ...
  {
    !isMobile ? (
      <div className={` ${nova_thai.className} w-[20%] flex-cols items-start justify-start px-[80px]`}>
  <Box className="bg-black rounded-none">
  ...
  <span className={`font-sm text-white ${nova.className} md:text-[32px] mb-5 md:-ml-4 items text-center flex justify-center items-center`}>EHA SHIVAM TECHNOLOGIES</span>
  ...
  <div className={` flex-cols bg-black text-white  md:font-md ${nova_thai.className}  font-sm `}>
